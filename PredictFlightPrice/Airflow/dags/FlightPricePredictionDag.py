...
DATA_DIR = ROOT_DIR / 'Airflow' / 'data'
ARTIFACTS_DIR = ROOT_DIR / 'Airflow' / 'artifacts'
...
def _resolve_raw_csv_path():
    candidates = [RAW_DATA_CSV, ROOT_DIR / 'data' / 'flights.csv', ROOT_DIR / 'Airflow' / 'dags' / 'flights.csv']
